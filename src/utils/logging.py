...
class NIDSLogger:
    ...
    def log_gradient_metrics(self, gradient_metrics: Dict[str, float], step: Optional[int] = None):
        ...
        try:
            ...
            filtered_metrics = {
                k: v for k, v in gradient_metrics.items() 
                if any(x in k for x in ['grad_global_norm', 'grad_health_score', 
                                      'grad_vanishing_ratio', 'grad_exploding_ratio'])
            }
            if filtered_metrics:
    ...
    def register_model(self, model, model_name: str, description: str = None, 
    ...
    def configure_gradient_logging(self, enabled: bool = None, console: bool = None, 
                                 csv: bool = None, mlflow: bool = None,
                                 log_frequency: int = None, mlflow_frequency: int = None,
                                 health_threshold: float = None, log_dir: str = None):
        ...
        self.info(f"Gradient logging configured: enabled={config.logging.gradient_logging_enabled}, "
